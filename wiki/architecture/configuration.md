...
| `labels` | object | Every user-facing/screen-reader string walle emits, grouped by area (skip link, breadcrumbs, carousel, filters, cart, price, offline, not-found, table of contents, nav, footer, blog, map). Each leaf has an English default; anything you don't set stays in English |
