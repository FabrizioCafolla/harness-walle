...
scenario_init_minimal() {
  ...
  # config.yml, lock, and the wiki docs. No root .walle.config.json.
  ...
  assert_path_present "$dir/.harness-walle/docs/get-started/index.md" || return 1
  assert_path_present "$dir/.harness-walle/docs/develop/cli.md" || return 1
