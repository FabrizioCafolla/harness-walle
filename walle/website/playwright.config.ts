...
export default defineConfig({
  ...
  use: {
    baseURL: "http://localhost:4321/walle-design-system",
  },
  webServer: {
    command: "yarn dev",
    // Must match use.baseURL: astro.config's base ("/walle-design-system", from
    ...
    url: "http://localhost:4321/walle-design-system",
