...
metadata:
  author: walle-design-system
  managed: "true"
---

# Updating walle

This project consumes [walle](https://github.com/FabrizioCafolla/walle-design-system), a copy-based design system. Managed paths under `@walle/` namespaces are overwritten on every update — treat them as read-only.
